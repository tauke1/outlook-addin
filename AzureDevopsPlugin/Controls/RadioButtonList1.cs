...
public class RadioButtonList1 : ListBox
{
    Size s;
    public RadioButtonList1()
    {
    ...
    protected override void OnDrawItem(DrawItemEventArgs e)
    {
        ...
        TextRenderer.DrawText(e.Graphics, text, Font, r, Color.Black, Items?.Count > 0 ? ((AzureDevopsPlugin.Models.WorkItem)Items[e.Index]).StateColor : bc, flags);
